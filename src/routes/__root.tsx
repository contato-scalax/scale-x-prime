...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "ScalaX Ascend is a premium, cinematic website experience showcasing data-driven growth strategies." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "ScalaX Ascend is a premium, cinematic website experience showcasing data-driven growth strategies." },
